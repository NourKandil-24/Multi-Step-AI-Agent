        ...
        try: # <--- THIS IS THE OUTER TRY
            ...
            if video_id_match:
                ...
                try:
                    ...
                    st.info("💡 If blocked, try switching to a Mobile Hotspot for a new IP.")
            
            else:
                st.error("Invalid YouTube URL format.")

        except Exception as outer_err: # <--- THIS FIXES THE ERROR
